...
const Technology = () => {
  return (
    <Layout>
      <div className="bg-gray-50 px-5 sm:px-10 md:px-20 lg:px-40 min-h-screen py-5 sm:py-10 bg-gradient-to-br from-cyan-800 via-blue-600 to-violet-600 w-full">
        <header className="text-center">
          <h1 className="text-xl sm:text-2xl lg:text-4xl font-bold text-gray-900 mb-4">
            Transforming Apple Orchard Management System with Drone Intelligent System
          </h1>
          <p className="text-sm sm:text-lg text-gray-700 max-w-xl mx-auto pb-10">
        ...
        <section className="bg-white p-5 sm:p-8 lg:px-20 lg:py-8 rounded-lg shadow-lg mb-8 ">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="lg:w-1/2">
              <img src="https://images.pexels.com/photos/28144764/pexels-photo-28144764/free-photo-of-a-bunch-of-apples-on-a-tree-with-leaves.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Tree Health Monitoring" className="w-full rounded-lg shadow-md h-[30vh] lg:h-[60vh]" />
            </div>
          </div>
        </section>

        {/* Section 2: Precision Nutrient, Pest, and Disease Management */}
        <section className="bg-indigo-50 p-5 sm:p-8 rounded-lg shadow-lg mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div className="lg:w-1/2 mb-8 lg:mb-0">
              <h2 className="text-2xl sm:text-3xl font-semibold text-indigo-600 mb-4">
            ...
            <div className="lg:w-1/2">
              <img src="https://images.pexels.com/photos/5528996/pexels-photo-5528996.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Precision Management" className="w-full rounded-lg shadow-md h-[30vh] lg:h-[60vh]" />
            </div>
          </div>
        </section>
        ...
        <section className="bg-white p-5 sm:p-8 rounded-lg shadow-lg mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="lg:w-1/2">
              <img src="https://www.researchgate.net/publication/338440436/figure/fig4/AS:844877197766657@1578445829192/Comparison-between-the-original-YOLOv3-tiny-and-our-modified-version-that-performs.jpg" alt="Data Analytics" className="w-full rounded-lg shadow-md h-[30vh] lg:h-[60vh]" />
            </div>
          </div>
        </section>
        ...
        <section className="bg-teal-50 p-5 sm:p-8 rounded-lg shadow-lg mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="lg:w-1/2">
              <img src="https://images.pexels.com/photos/4916114/pexels-photo-4916114.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Marketing Tools" className="w-full rounded-lg shadow-md h-[30vh] lg:h-[60vh]" />
            </div>
          </div>
        </section>
        ...
        <section className="bg-teal-50 p-5 sm:p-8 rounded-lg shadow-lg mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="lg:w-1/2">
              <img src="\images\single_drone.jpg" alt="Marketing Tools" className="w-full rounded-lg shadow-md h-[30vh] lg:h-[60vh]" />
            </div>
          </div>
        </section>
        ...
        <section className="bg-teal-50 p-5 sm:p-8 rounded-lg shadow-lg mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="lg:w-1/2">
              <img src="\images\double_drone.jpg" alt="Marketing Tools" className="w-full rounded-lg shadow-md h-[30vh] lg:h-[60vh]" />
            </div>
          </div>
        </section>
