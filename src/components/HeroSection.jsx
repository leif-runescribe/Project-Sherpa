...
export default function HeroSection() {
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto sm:px-20 py-20 px-10">
        <div className="relative z-10 text-center pb-8 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32 mx-auto">
          <main className="mt-20 max-w-4xl mx-auto sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28">
            <div className="text-center">
              <h1 className="text-4xl md:mt-40 mt-28 font-extrabold text-white sm:text-6xl md:text-6xl">
              ...
              <p className="mt-3 text-center text-gray-300 sm:mt-5 sm:text-3xl sm:max-w-xl md:mt-5 md:text-3xl">
              ...
              <div className="text-white text-3xl pt-12 max-w-4xl mx-auto">
